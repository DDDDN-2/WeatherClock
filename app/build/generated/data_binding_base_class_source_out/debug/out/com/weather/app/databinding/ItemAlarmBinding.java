...
public final class ItemAlarmBinding implements ViewBinding {
  ...
  private ItemAlarmBinding(@NonNull MaterialCardView rootView, @NonNull SwitchMaterial switchAlarm,
  ...
  public static ItemAlarmBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemAlarmBinding((MaterialCardView) rootView, switchAlarm, tvLabel, tvTime);
    }
